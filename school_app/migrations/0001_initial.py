    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='library_records', to='school_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='FeesHistory',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fees_records', to='school_app.student')),
            ],
        ),
    ]
